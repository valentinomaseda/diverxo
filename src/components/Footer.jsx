  ...
  return (
    <footer className="relative z-20 bg-dark py-12 border-t border-brand/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center bg-dark">
        ...
        <p className="border-t border-gray-800 pt-8 text-sm text-gray-500">
          &copy; {new Date().getFullYear()} DiverXo Pizzería. Todos los derechos reservados. Creado en Arrecifes.
        </p>
      </div>
    </footer>
  );
